...
class getRouting_LoaderService extends App_KernelProductionDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($c, 'production'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($c, 'production'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($c, 'production'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($c, 'production'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($c, 'production'));
